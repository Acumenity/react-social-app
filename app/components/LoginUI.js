    ...
    <div className="container" style={divStyle}>
      <form className="form-signin">
        ...
        <div className="login-box">
					...
					<input type="text" id="inputEmail" className="form-control" placeholder="Email address" onChange = {this.props.onUpdateUserState} value={this.props.username} required="" autofocus=""/>
